...
static const AVOption vc2enc_options[] = {
    ...
    {"wavelet_type",  "Transform type",  offsetof(VC2EncContext, wavelet_idx), AV_OPT_TYPE_INT, {.i64 = VC2_TRANSFORM_HAAR_S}, VC2_TRANSFORM_5_3, VC2_TRANSFORM_HAAR_S, VC2ENC_FLAGS, "wavelet_idx"},
